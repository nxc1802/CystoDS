...
# %%
# CELL 2 - All simplified baseline-suite configuration for ALL 5 trials.
import os
...
STAGE_NAME = "stage_10_simplified_baselines"
...
EXPECTED_PROTOCOL_SHA256 = os.environ.get("CYSTODS_EXPECTED_PROTOCOL_SHA256")
...
HF_REPO_ID = os.environ.get("CYSTODS_HF_REPO_ID", "Cuong2004/CystoDS-Checkpoints")
...
os.environ["CYSTODS_HF_REPO_ID"] = HF_REPO_ID
...
def _make_base_config() -> dict:
    config = {
        ...
        "image_size": 224,
        "fov_center_crop_ratio": 1.0,
        # DATA AUGMENTATION: Disabled (Pure Paper Baseline)
        ...
        "prefetch_factor": int(os.environ.get("CYSTODS_PREFETCH_FACTOR", "2")),
        "eval_batch_size": int(
        ...
        # OPTIMIZER & SCHEDULER: Standard Un-optimized Setup
        "epochs": 25,
        "learning_rate": 1.0e-4,
        "encoder_learning_rate_multiplier": 1.0,
        "weight_decay": 0.01,
        "optimizer": "adamw",
        ...
        "checkpoint_backend": os.environ.get(
            "CYSTODS_CHECKPOINT_BACKEND",
            "local" if RUN_PROFILE == "smoke" else "huggingface",
        ),
...
# Baseline Trials for Simplified Stage 10 (Swin Tiny, ResNet-152, HRNet-W18, ResNeXt50)
TRIALS = (
    {
    ...
    {
        "experiment_id": "multitask_binary_coarse_swin_tiny",
        "task_mode": "multitask",
        "overrides": {
            "model_name": "swin_tiny_patch4_window7_224.ms_in1k",
            "binary_loss_weight": 1.0,
    ...
    {
        "experiment_id": "multitask_binary_coarse_fine_swin_tiny",
        "task_mode": "multitask",
        "overrides": {
            "model_name": "swin_tiny_patch4_window7_224.ms_in1k",
            "binary_loss_weight": 1.0,
    ...
    {
        "experiment_id": "multitask_binary_coarse_fine_hrnet_w18",
        "task_mode": "multitask",
        "overrides": {
            "model_name": "hrnet_w18.ms_in1k",
            "binary_loss_weight": 1.0,
    ...
    {
        "experiment_id": "multitask_binary_coarse_fine_resnext50_32x4d",
        "task_mode": "multitask",
        "overrides": {
            "model_name": "resnext50_32x4d.a1_in1k",
            "binary_loss_weight": 1.0,
...
try:
    ...
    _THIS_SOURCE = (
        Path.cwd() / "stage_10_simplified_baselines.py"
    ).resolve()
...
if __name__ == "__main__":
    ...
    print(
        f"Completed simplified baseline stage: {COMPLETED_RUN_DIRECTORY}"
    )
