...
# %%
# CELL 2 - All ablation-suite configuration.
import os
...
RESEARCH_TRIALS = (
    ...
    {
        "experiment_id": "ablation_hierarchical_ce",
        "task_mode": "hierarchical",
        "overrides": {
            "fine_loss": "cross_entropy",
            "supervised_contrastive_loss_weight": 0.0,
    ...
    {
        "experiment_id": "ablation_no_binary_auxiliary",
        "task_mode": "hierarchical",
    ...
    },
    {
        ...
        "task_mode": "hierarchical",
        "overrides": {"supervised_contrastive_loss_weight": 0.0},
    },
    {
        "experiment_id": "ablation_class_balanced_sampler",
        "task_mode": "hierarchical",
        "overrides": {
    ...
    {
        "experiment_id": "ablation_train_all_evaluate_wlc",
        "task_mode": "hierarchical",
        "overrides": {
            "train_modality": "all",
            "evaluate_wlc_only": True,
...
SMOKE_TRIALS = (
    {
        "experiment_id": "smoke_hierarchical_full",
        "task_mode": "hierarchical",
        "overrides": {
            "model_name": "swin_tiny_patch4_window7_224.ms_in1k",
            "pretrained": False,
...
try:
    ...
    _THIS_SOURCE = (Path.cwd() / "stage_40_run_ablations.py").resolve()
...
if __name__ == "__main__":
    ...
    print(f"Completed ablation stage: {COMPLETED_RUN_DIRECTORY}")
