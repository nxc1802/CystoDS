...
- **[Bảng 0: Bảng Đối Chuẩn Trực Tiếp Trên Tập Hold-out Test Độc Lập](#0-bảng-đối-chuẩn-trực-tiếp-trên-tập-hold-out-test-độc-lập-cystohier-vs-baselines)**
...
- **[Bảng 2: Stage 20 -- Sàng Lọc 7 Hàm Mất Mát Đuôi Dài (Patient Prior vs Image Prior)](#2-stage-20----sàng-lọc-7-hàm-mất-mát-đuôi-dài-validation-benchmark)**
- **[Bảng 3: Stage 30 & 40 -- Phân Rã Hệ Thống Bóc Tách Thực Nghiệm (Comprehensive Ablation Studies)](#3-stage-30--40----hệ-thống-bóc-tách-thực-nghiệm-toàn-diện-comprehensive-ablation-studies)**
  - [Bảng 3.1: Khảo sát Chiến Lược & Quy Trình Huấn Luyện (Training Paradigm & Stage Decoupling)](#bảng-31-khảo-sát-chiến-lược--quy-trình-huấn-luyện-training-paradigm--stage-decoupling)
  - [Bảng 3.2: Khảo sát Lịch Trình Trọng Số Phân Cấp (Hierarchy Loss Scheduling & Curriculum Warmup)](#bảng-32-khảo-sát-lịch-trình-trọng-số-phân-cấp-hierarchy-loss-scheduling--curriculum-warmup)
  - [Bảng 3.3: Bóc Tách Đóng Góp Cận Biên Của Các Thành Phần Hàm Loss](#bảng-33-bóc-tách-đóng-góp-cận-biên-của-các-thành-phần-hàm-loss)
  - [Bảng 3.4: Khảo sát Vị Trí Trích Xuất Đặc Trưng Theo Độ Sâu (Head Placement)](#bảng-34-khảo-sát-vị-trí-trích-xuất-đặc-trưng-theo-độ-sâu-architectural-head-placement)
  - [Bảng 3.5: Khảo sát Độ Sâu Đóng Băng Backbone & Đánh Đổi Chi Phí Tính Toán](#bảng-35-khảo-sát-độ-sâu-đóng-băng-backbone--đánh-đổi-chi-phí-tính-toán)
  - [Bảng 3.6: Khảo sát Độ Nhạy Siêu Tham Số & Cơ Chế Suy Luận Kết Hợp](#bảng-36-khảo-sát-độ-nhạy-siêu-tham-số--cơ-chế-suy-luận-kết-hợp)
- **[Bảng 4: Phân Tích Chi Tiết Từng Nhóm Lâm Sàng & Benchmark Thời Gian Thực](#4-phân-tích-chi-tiết-từng-nhóm-lâm-sàng--benchmark-thời-gian-thực)**
- **[Bảng 5: Ngoại Kiểm Trên Tập Dữ Liệu Độc Lập Đa Trung Tâm Lazo et al. (External Cohort)](#5-ngoại-kiểm-trên-tập-dữ-liệu-độc-lập-đa-trung-tâm-lazo-et-al-2023-external-cohort)**
- **[Bảng 6: Phân Tích Chi Tiết 22 Phân Lớp Chẩn Đoán (22 Fine-grained Diagnostic Categories)](#6-phân-tích-chi-tiết-22-phân-lớp-chẩn-đoán-22-fine-grained-diagnostic-categories)**
- **[Bảng 7: Khảo Sát Độ Nhạy Ngưỡng & Trực Quan Hóa Grad-CAM](#7-khảo-sát-độ-nhạy-ngưỡng--trực-quan-hóa-grad-cam)**

---

## 0. Bảng Đối Chuẩn Trực Tiếp Trên Tập Hold-out Test Độc Lập: CystoHier vs. Baselines

Bảng đối chuẩn khách quan trên **tập Test độc lập 100% bệnh nhân** (24 bệnh nhân, 337 ảnh) giữa mô hình đề xuất tối ưu (**CystoHier**) và toàn bộ các mô hình baseline (đơn nhiệm & đa nhiệm):
...
|:---:|---|---|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **🏆** | **Proposed Method** | **CystoHier (Full Proposed)** | **Curriculum Warmup + Hierarchical Ens.** | **0.9986 ± 0.0002** 🏆 | **0.9845 ± 0.005** 🏆 | **0.9912 ± 0.004** 🏆 | **0.9882 ± 0.003** 🏆 | **0.9811 ± 0.004** 🏆 | **86.42% ± 3.5%** 🏆 | **0.7572 ± 0.117** 🏆 | **74.73% ± 11.9%** 🏆 | **0.6450 ± 0.111** 🏆 | **0.4691 ± 0.080** 🏆 | **89.52% ± 3.8%** 🏆 | **86.42% ± 3.5%** 🏆 |
|---|---|---|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Kiểm định Thống kê Cặp:**
* vs. Multitask Swin-Tiny: $\Delta \text{Fine Macro-F1} = +0{,}0347$ (KTC 95\%: $[+0{,}0008; +0{,}0685]$, **$p = 0{,}0478 < 0{,}05$**).
* vs. Single-Task Swin-Tiny: $\Delta \text{Fine Macro-F1} = +0{,}0610$ (**$p = 0{,}0091 < 0{,}01$**).
...
| 12 | Single Fine | **ResNet-152 (Fine Only)** | Fine CE Only | — | — | — | — | — | — | 31.39% ± 2.5% | **0.2164 ± 0.021** 🥉 | **0.1598 ± 0.006** 🥉 |

---

## 2. Stage 20 -- Sàng Lọc 7 Hàm Mất Mát Đuôi Dài (Validation Benchmark)

| # | Hàm Mất Mát | Cơ Chế Tiên Nghiệm | Binary AUROC | Binary Sens | Binary Spec | Binary F1 | Coarse Acc (%) | Coarse Macro-F1 | Fine Acc (%) | Fine F1 (Supp) | Primary Fine F1 (13 Lớp) | Tail Recall (n <= 20) | C-F Consistency (%) |
|:---:|---|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 1 | **PP-SBS (Proposed)** | **Patient Prior ($\text{pat}_j^{0.5}$)** | **0.9521 ± 0.039** 🥉 | **0.8850 ± 0.045** 🥇 | **0.9120 ± 0.035** 🥈 | **0.8907 ± 0.058** 🥈 | **70.12% ± 3.9%** 🥇 | **0.6212 ± 0.038** 🥇 | **52.45% ± 1.7%** 🥇 | **0.5506 ± 0.074** 🥇 | **0.5607 ± 0.050** 🥇 | **66.38% ± 11.4%** 🥇 | **77.58% ± 1.6%** 🥇 |
| 2 | **Balanced Softmax** | Image Instance Prior ($n_j$) | **0.9531 ± 0.038** 🥇 | 0.8710 ± 0.038 | **0.9150 ± 0.032** 🥇 | **0.8893 ± 0.031** 🥉 | **69.58% ± 2.6%** 🥉 | **0.5912 ± 0.032** 🥈 | 50.08% ± 5.7% | 0.4823 ± 0.060 | 0.5049 ± 0.022 | 62.76% ± 6.1% | 74.57% ± 3.7% |
| 3 | **Logit Adjustment** | Post-hoc Shift | 0.9455 ± 0.042 | 0.8650 ± 0.041 | 0.9080 ± 0.038 | 0.8888 ± 0.050 | **69.98% ± 3.0%** 🥈 | **0.5837 ± 0.022** 🥉 | 49.62% ± 1.7% | 0.4822 ± 0.048 | 0.5041 ± 0.034 | 59.67% ± 8.4% | 76.98% ± 3.4% |
...
### Bảng 3.1: Khảo sát Chiến Lược & Quy Trình Huấn Luyện (Training Paradigm & Stage Decoupling)
...
|:---:|---|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 1 | **CystoHier (Proposed)** | **Rep $\rightarrow$ Coarse Align $\rightarrow$ Fine Align** | 0.9571 ± 0.021 | **0.8960 ± 0.026** 🥉 | **78.37% ± 1.0%** 🥇 | **0.6525 ± 0.012** 🥉 | **53.07% ± 4.0%** 🥇 | **0.5415 ± 0.036** 🥇 | **0.4007 ± 0.015** 🥇 | **82.28% ± 0.5%** 🥇 | **78.37% ± 1.0%** 🥇 |
...
| 3 | **2-Stage Decoupled (D2S)** | Rep $\rightarrow$ Fine-Only SBS (Stage 35) | **0.9617 ± 0.028** 🥈 | 0.8912 ± 0.022 | 72.12% ± 4.6% | 0.6313 ± 0.031 | 52.20% ± 4.8% | 0.5266 ± 0.056 | 0.3893 ± 0.032 | **78.90% ± 2.4%** 🥈 | 72.50% ± 3.5% |
...
### Bảng 3.2: Khảo sát Lịch Trình Trọng Số Phân Cấp (Hierarchy Loss Scheduling & Curriculum Warmup)
...
### Bảng 3.3: Bóc Tách Đóng Góp Cận Biên Của Các Thành Phần Hàm Loss
...
| 3 | **w/o PP-SBS Loss** | Thay bằng Cross-Entropy thường | 0.9534 ± 0.021 | 0.8937 ± 0.026 | 70.93% ± 1.1% | 48.92% ± 3.2% ⬇️ | 0.6004 ± 0.026 (**-1.10%**) | 59.86% ± 9.4% (**-5.37%**) | 78.58% ± 3.7% (**-4.22%**) |
...
### Bảng 3.4: Khảo sát Vị Trí Trích Xuất Đặc Trưng Theo Độ Sâu (Architectural Head Placement)
...
### Bảng 3.5: Khảo sát Độ Sâu Đóng Băng Backbone & Đánh Đổi Chi Phí Tính Toán (Backbone Freezing Depth & Compute Trade-off)
...
### Bảng 3.6: Khảo sát Độ Nhạy Siêu Tham Số & Cơ Chế Suy Luận Kết Hợp (Hyperparameters & Inference Blending)
...
## 4. Phân Tích Chi Tiết Từng Nhóm Lâm Sàng & Benchmark Thời Gian Thực
...
## 5. Ngoại Kiểm Trên Tập Dữ Liệu Độc Lập Đa Trung Tâm Lazo et al. (2023) (External Cohort)

Đánh giá năng lực tổng quát hóa ngoại kiểm (Zero-Shot Direct Inference) trên toàn bộ **1.754 ảnh nội soi / 23 bệnh nhân** của bộ dữ liệu quốc tế Lazo et al. (IEEE TBME 2023) [7] (WLI + NBI) mà không qua bất kỳ bước fine-tuning hay thích ứng miền nào:

| Phân nhóm / Chỉ số | Swin Baseline (Binary Only) | CystoHier (Proposed Direct) | CystoHier (Ensemble) |
|---|:---:|:---:|:---:|
| **Toàn bộ Ngoại kiểm (WLI + NBI, N=1.754 ảnh / 23 BN):** | | | |
| **AUROC** | 0.9503 $\pm$ 0.0170 | **0.9587 $\pm$ 0.0118** | 0.9065 $\pm$ 0.0379 |
| **F1-Score** | 0.8821 $\pm$ 0.0221 | **0.8875 $\pm$ 0.0179** | 0.8600 $\pm$ 0.0145 |
| **Accuracy (%)** | 84.80% $\pm$ 2.51% | **85.37% $\pm$ 2.05%** | 81.45% $\pm$ 1.96% |
| **Sensitivity (%)** | 80.16% $\pm$ 3.62% | **81.23% $\pm$ 3.15%** | 79.92% $\pm$ 2.83% |
| **Specificity (%)** | **96.30% $\pm$ 0.34%** | 95.63% $\pm$ 1.55% | 85.25% $\pm$ 8.61% |
| **Balanced Accuracy (%)** | 88.23% $\pm$ 1.70% | **88.43% $\pm$ 1.36%** | 82.59% $\pm$ 3.58% |
| **Phân nhóm WLI Only (N=1.433 ảnh):** | | | |
| AUROC | 0.9528 $\pm$ 0.0200 | **0.9633 $\pm$ 0.0154** | 0.9073 $\pm$ 0.0458 |
| Accuracy (%) | **86.76% $\pm$ 2.38%** | 86.35% $\pm$ 2.48% | 82.00% $\pm$ 2.72% |
| F1-Score | **0.8971 $\pm$ 0.0205** | 0.8941 $\pm$ 0.0214 | 0.8629 ± 0.0202 |
| **Phân nhóm NBI Only (N=321 ảnh, Ánh sáng dải hẹp):** | | | |
| AUROC | **0.9528 $\pm$ 0.0073** | 0.9414 $\pm$ 0.0114 | 0.9093 ± 0.0153 |
| Accuracy (%) | 76.01% $\pm$ 4.35% | **81.00% $\pm$ 4.83% (+4.99%)** | 79.02% ± 3.28% |
| Sensitivity (%) | 69.78% $\pm$ 6.35% | **75.47% $\pm$ 6.47% (+5.69%)** | 76.15% ± 5.04% |
| Specificity (%) | 96.44% $\pm$ 2.27% | **99.11% $\pm$ 0.63% (+2.67%)** | 88.44% ± 6.56% |
| F1-Score | 0.8151 $\pm$ 0.0404 | **0.8573 $\pm$ 0.0414 (+0.0422)** | 0.8468 ± 0.0284 |

**Phân nhóm Bệnh học & Kiểm định Mức Bệnh nhân:**
* **HGC Sensitivity (N=469):** Proposed **89.48% $\pm$ 1.96%** (vs 88.56% Swin Baseline).
* **LGC Sensitivity (N=647):** Proposed **82.53% $\pm$ 4.99%** (vs 82.59% Swin Baseline).
* **NTL Sensitivity (N=134):** Proposed Direct **46.02% $\pm$ 4.57%**, Ensemble **51.99% $\pm$ 8.32%** (vs 39.05% Baseline, **+12.94%**).
* **NST Specificity (N=504):** Specificity **95.63% $\pm$ 1.55%** (vs 96.30% Baseline).
* **Patient-Level Bootstrap (1.000 resamples):** AUROC = **$0.9574 \pm 0.0121$** (KTC 95%: $[0.9312; 0.9788]$); Specificity = **$96.20\% \pm 1.08\%$** (KTC 95%: $[0.9381; 0.9784]$).

---

## 6. Phân Tích Chi Tiết 22 Phân Lớp Chẩn Đoán (22 Fine-grained Diagnostic Categories)
...
$\dagger$: Phân lớp đuôi dài hiếm gặp ($\le 5$ bệnh nhân hoặc $\le 20$ ảnh trong bộ dữ liệu).

---

## 7. Khảo Sát Độ Nhạy Ngưỡng & Trực Quan Hóa Grad-CAM

### Bảng 7.1: Định lượng Grad-CAM IoU trên Mặt nạ Ground-Truth Bác sĩ (T=0.5)
| # | Phân Lớp Chẩn Đoán | Nhóm Phân Loại Cha | Nguồn Mẫu | Swin IoU (%) | CystoHier Conf. | CystoHier IoU (%) | Mức Nâng Cao ($\Delta$ IoU) |
|:---:|---|---|:---:|:---:|:---:|:---:|:---:|
| 1 | **LowGradePapillary** | Malignant | Test Hold-out | 1.12% | 0.979 | **37.78%** | **+36.65% (Gấp 33.7 lần)** |
| 2 | **AirBubble** | Foreign bodies | Test Hold-out | 0.00% | 1.000 | **24.60%** | **+24.60%** |
| 3 | **HighGradePapillary** | Malignant | Test Hold-out | 5.56% | 1.000 | **17.17%** | **+11.61%** |
| 4 | **UreteralOrifice** | Landmarks | Test Hold-out | 16.44% | 0.993 | **20.50%** | **+4.06%** |
| 5 | **ResectionScar** | Landmarks | Split 0 Hold-out | 1.87% | 1.000 | **17.77%** | **+15.91%** |
| **TB** | **Trung Bình Toàn Bộ** | — | — | **5.00%** | **0.994** | **23.56%** | **+18.56% [Gấp 4.71 lần]** |

### Bảng 7.2: Khảo sát Độ Nhạy Ngưỡng Kích Hoạt Grad-CAM ($T \in [0.3; 0.6]$)
| Ngưỡng Kích Hoạt ($T$) | Baseline IoU (%) | Baseline Dice | CystoHier IoU (%) | CystoHier Dice | Tỷ lệ Tăng Cường IoU |
|:---:|:---:|:---:|:---:|:---:|:---:|
| $T = 0.3$ | 5.71% | 0.108 | **14.89%** | **0.259** | **2.61×** |
| $T = 0.4$ | 5.26% | 0.100 | **17.85%** | **0.303** | **3.39×** |
| $T = 0.5$ (Chuẩn) | 5.00% | 0.095 | **23.56%** | **0.381** | **4.71×** |
| $T = 0.6$ | 4.55% | 0.087 | **22.47%** | **0.367** | **4.94×** |
