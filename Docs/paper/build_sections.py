...
SECTION_DEFS = [
    ...
    {
        "id": "02_Methodology",
        "title": "CystoDS: Phương Pháp Phân Cấp Hai Giai Đoạn Tách Rời (D2S-HFT)",
        "subtitle": "Kiến trúc Swin-Tiny kết hợp Selective Classifier Alignment và Ràng Buộc Phân Cấp Y Học",
        "header_left": "CystoDS -- Phương Pháp Đề Xuất (Decoupled Two-Stage D2S-HFT)",
        "regex": r"(## 3\. Phương pháp[\s\S]*?)(?=## 4\. Kết quả)",
        "filename_stem": "CystoDS_02_Methodology_VI",
    },
    {
        "id": "03_Experiment",
        "title": "CystoDS: Kết Quả Thực Nghiệm Đa Tầng và Nghiên Cứu Triệt Tiêu",
        "subtitle": "Đánh giá toàn diện qua 3 hold-out splits độc lập và bóc tách định lượng 5 biến thể (Stages 10--40)",
        "header_left": "CystoDS -- Báo cáo Kết Quả Thực Nghiệm và Ablations (Stages 10--40)",
        "regex": r"(## 4\. Kết quả[\s\S]*?)(?=## 5\. Thảo luận)",
